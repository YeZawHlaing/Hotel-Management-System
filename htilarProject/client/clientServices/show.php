...
$fetching_rooms = mysqli_query($con, "SELECT room.*, room_avaliable.*
                                      ...
                                      WHERE room_avaliable.status = '$inActive'
                                      AND room.type = '$type'");

$fetching_room_out = mysqli_query($con, "SELECT room.*, room_avaliable.*
                                      FROM room
                                      INNER JOIN room_avaliable ON room.room_id = room_avaliable.room_id
                                      WHERE room_avaliable.status = '$active'
                                      AND room.type = '$type'");
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ml">
                        ...
                        <li class="nav-item dropdown mx-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="../webpage/home.php">Event</a></li>
                            </ul>
                        </li>
                        <li class="nav-item mx-2">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <button type='button' class='btn btn-primary text-white'> <a href="../webpage/booking.php" class="text-white" style="text-decoration: none;">Book Now</a></button>
