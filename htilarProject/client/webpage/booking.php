...
<body class="vh-100 overflow-x-hidden">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ml">
                        ...
                        <li class="nav-item dropdown mx-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="../webpage/event.php">Event</a></li>
                            </ul>
                        </li>
                        <li class="nav-item mx-2">
    ...
    <br><br><br>
    <div class="container">
    <form class="row g-3" method="post" action="../clientServices/bookingService.php">
        <h1 class="text-center">Ha Tinh Resort Booking Form</h1>
        <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="ph" name="ph_no">
  </div>
  <div class="col-md-6">
