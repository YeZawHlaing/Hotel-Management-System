    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            <div class="col-auto col-md-4 col-lg-3 min-vh-100">
                <div class="left p-2">
                    ...
                    <ul class="nav nav-pills flex-column mt-5">
                        ...
                        <li class="nav-item"><a class="nav-link text-white active" href="../webpage/manageEvent.php">manage events</a></li>
            ...
            <div class="col-auto col-md-8 col-lg-9 min-vh-100">
                <h2 class="text-center">Upload Event</h2>
                <form method="post" action="../service/uploadEvent.php" enctype="multipart/form-data">
                    <div class="mb-3">
                ...
                <form method="post" action="../service/upldateEvent.php" enctype="multipart/form-data">
                <div class="mb-3">
                        <label for="id" class="form-label">Enter event id</label>
                        <input type="text" class="form-control" name="e_id" id="id" required>
                    </div>
                    <div class="mb-3">
